...
func newApp(db *gorm.DB, opts ...gen.DOOption) app {
	...
	_app.Describe = field.NewString(tableName, "describe")
	_app.Domain = field.NewInt32(tableName, "domain")
...
type app struct {
	...
	Domain      field.Int32  // 领域范畴
	Key         field.String // 应用key
	Secret      field.String // 应用密钥
	Status      field.Int32  // 应用状态： 0 未激活; 1 未使用；2 使用中；3 已销毁；4 阻断中；5 限制中
...
func (a *app) updateTableName(table string) *app {
	...
	a.Domain = field.NewInt32(table, "domain")
...
type IAppDo interface {
	...
	Unscoped() IAppDo
	Create(values ...*dao.App) error
	CreateInBatches(values []*dao.App, batchSize int) error
	Save(values ...*dao.App) error
	First() (*dao.App, error)
	Take() (*dao.App, error)
	Last() (*dao.App, error)
	Find() ([]*dao.App, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dao.App, err error)
	FindInBatches(result *[]*dao.App, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dao.App) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dao.App, error)
	FirstOrCreate() (*dao.App, error)
	FindByPage(offset int, limit int) (result []*dao.App, count int64, err error)
